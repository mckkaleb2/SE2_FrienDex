...
{
    public TaskCompletionSource<Room?> ResultTcs { get; } = new();

    public CreateRoomPage(IRoomRepo roomRepo)
    {
        InitializeComponent();
        BindingContext = new AddRoomViewModel(this, roomRepo);
    }
}

public class AddRoomViewModel : INotifyPropertyChanged
{
    private readonly CreateRoomPage _page;
    ...
    public AddRoomViewModel(CreateRoomPage page, IRoomRepo roomRepo)
    {
        _page = page;
        _roomRepo = roomRepo;
    ...
    private async Task OnSaveAsync()
    {
        ...
        await _roomRepo.CreateAsync(newRoom);
