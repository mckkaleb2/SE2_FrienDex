...
- [Issues In FrienDex](#issues-in-friendex)
...
1. By opening the issue for discussion: If you believe that you have found
   a new bug in FrienDex, you should report it by creating a new issue in
...
3. By helping to resolve the issue: This can be done by demonstrating
   ...
   a pull request that changes the source in `mckkaleb2/SE2_FrienDex` in a
   concrete and reviewable manner.

## Asking for General Help

<!-- TODO: Set up a website -->
~~[The FrienDex website](https://github.com/mckkaleb2/SE2_FrienDex)~~ has a
...
When opening a new issue in the [`mckkaleb2/SE2_FrienDex` issue tracker](https://github.com/mckkaleb2/SE2_FrienDex/issues/new/choose), users
will be presented with a template that should be filled in.

If you believe that you have found a bug in FrienDex, please fill out the template
