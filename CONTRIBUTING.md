...
behavior to ~~coc@electronjs.org~~ a [Code Owner](../../.github/CODEOWNERS).
Once an email address is established for the project, this section will be updated.

The following is a set of guidelines for contributing to FrienDex.
...
Issues are created [here](https://github.com/mckkaleb2/SE2_FrienDex/issues/new/choose).
...
<!-- At the moment, FrienDex maintains its three latest major versions, with a new major version being released every 8 weeks.  -->
<!-- For more information on FrienDex's release cadence, see [this blog post](https://electronjs.org/blog/8-week-cadence).) -->
...
dependencies, and tools contained in the `mckkaleb2/SE2_FrienDex` repository.
...
See [Coding Style](https://electronjs.org/docs/development/coding-style) for information about which standards FrienDex adheres to in different parts of its codebase. -->

## Further Reading

For more in-depth guides on developing FrienDex, see
